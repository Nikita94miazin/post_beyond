...
class Error:
    ...
    group_already_exists: CustomError = CustomError(601, "Group with the same name is already exist")
    group_not_exists: CustomError = CustomError(602, "Group doesn't exist")
    ...
    role_not_exists: CustomError = CustomError(703, "User role doesn't exist")
    user_not_exists: CustomError = CustomError(704, "User doesn't exist")
    ...
    status_not_exists: CustomError = CustomError(1002, "Sent status is not exist")
